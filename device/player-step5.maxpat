...
,
		...
		"boxes" : [
			{ "box" : { "id" : "obj-1", "maxclass" : "comment", "text" : "S.O.S Player - patch complet etapes 1 a 5a. Tout selectionner / copier, coller dans le device (remplace le contenu). Le v8 doit trouver player.js.", "numinlets" : 1, "numoutlets" : 0, "patching_rect" : [ 40.0, 18.0, 720.0, 20.0 ], "fontsize" : 12.0 } },
