...
,
		...
		"boxes" : [
			{ "box" : { "id" : "obj-1", "maxclass" : "comment", "text" : "S.O.S Player - patch complet etapes 1 a 4. Tout selectionner / copier, puis coller dans le device (remplace le contenu). Le v8 doit trouver player.js (search path deja regle).", "numinlets" : 1, "numoutlets" : 0, "patching_rect" : [ 40.0, 18.0, 700.0, 20.0 ], "fontsize" : 12.0 } },
			...
			{ "box" : { "id" : "obj-16", "maxclass" : "comment", "text" : "reponses Holophonix", "numinlets" : 1, "numoutlets" : 0, "patching_rect" : [ 450.0, 48.0, 200.0, 18.0 ], "fontsize" : 12.0 } },
			{ "box" : { "id" : "obj-14", "maxclass" : "newobj", "text" : "udpreceive 4004", "numinlets" : 0, "numoutlets" : 1, "outlettype" : [ "" ], "patching_rect" : [ 450.0, 70.0, 110.0, 22.0 ], "fontsize" : 12.0 } },
			{ "box" : { "id" : "obj-15", "maxclass" : "newobj", "text" : "print osc_in", "numinlets" : 1, "numoutlets" : 0, "patching_rect" : [ 580.0, 70.0, 100.0, 22.0 ], "fontsize" : 12.0 } },
			...
			{ "box" : { "id" : "obj-13", "maxclass" : "comment", "text" : "ou edite ce chemin a la main", "numinlets" : 1, "numoutlets" : 0, "patching_rect" : [ 470.0, 163.0, 230.0, 18.0 ], "fontsize" : 12.0 } },
			{ "box" : { "id" : "obj-12", "maxclass" : "message", "text" : "folder /chemin/vers/dossier-mp3", "numinlets" : 2, "numoutlets" : 1, "outlettype" : [ "" ], "patching_rect" : [ 470.0, 185.0, 230.0, 22.0 ], "fontsize" : 12.0 } },
			...
			{ "box" : { "id" : "obj-24", "maxclass" : "comment", "text" : "OSC -> Holophonix (v8 outlet 1)", "numinlets" : 1, "numoutlets" : 0, "patching_rect" : [ 300.0, 300.0, 240.0, 18.0 ], "fontsize" : 12.0 } },
			{ "box" : { "id" : "obj-17", "maxclass" : "newobj", "text" : "v8 player.js", "numinlets" : 1, "numoutlets" : 3, "outlettype" : [ "", "", "" ], "patching_rect" : [ 40.0, 320.0, 110.0, 22.0 ], "fontsize" : 12.0 } },
			{ "box" : { "id" : "obj-23", "maxclass" : "newobj", "text" : "udpsend 127.0.0.1 4003", "numinlets" : 1, "numoutlets" : 0, "patching_rect" : [ 300.0, 322.0, 180.0, 22.0 ], "fontsize" : 12.0 } },

			{ "box" : { "id" : "obj-22", "maxclass" : "comment", "text" : "fin de lecture (sorties 2 et 3) -> done", "numinlets" : 1, "numoutlets" : 0, "patching_rect" : [ 275.0, 392.0, 240.0, 18.0 ], "fontsize" : 12.0 } },
			{ "box" : { "id" : "obj-18", "maxclass" : "newobj", "text" : "sfplay~ 2", "numinlets" : 1, "numoutlets" : 4, "outlettype" : [ "signal", "signal", "signal", "bang" ], "patching_rect" : [ 40.0, 390.0, 90.0, 22.0 ], "fontsize" : 12.0 } },
			{ "box" : { "id" : "obj-21", "maxclass" : "message", "text" : "done", "numinlets" : 2, "numoutlets" : 1, "outlettype" : [ "" ], "patching_rect" : [ 205.0, 390.0, 60.0, 22.0 ], "fontsize" : 12.0 } },

			{ "box" : { "id" : "obj-20", "maxclass" : "comment", "text" : "audio mono -> sortie piste (canal Bridge de la source)", "numinlets" : 1, "numoutlets" : 0, "patching_rect" : [ 140.0, 452.0, 300.0, 18.0 ], "fontsize" : 12.0 } },
			{ "box" : { "id" : "obj-19", "maxclass" : "newobj", "text" : "plugout~ 1 2", "numinlets" : 2, "numoutlets" : 0, "patching_rect" : [ 40.0, 450.0, 90.0, 22.0 ], "fontsize" : 12.0 } }
		],
		"lines" : [
			...
			{ "patchline" : { "source" : [ "obj-12", 0 ], "destination" : [ "obj-17", 0 ] } },
